...
import type { AswMediaMentionsAttrs } from "./schema";

const emptyItem: AswMediaMentionsAttrs["items"][number] = {
  title: "",
  source: "",
  byline: "",
  summary: "",
...
export function AswMediaMentionsEditor({
  attrs,
  onChange,
  disabled,
}: BlockEditorProps<AswMediaMentionsAttrs>) {
  const updateItem = (index: number, patch: Partial<AswMediaMentionsAttrs["items"][number]>) => {
    onChange({
      ...attrs,
