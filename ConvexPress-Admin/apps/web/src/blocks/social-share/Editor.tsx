...
import type { SocialShareAttrs } from "./schema";

const networkOptions: Array<[SocialShareAttrs["networks"][number], string]> = [
  ["facebook", "Facebook"],
  ["x", "X"],
  ["pinterest", "Pinterest"],
  ["linkedin", "LinkedIn"],
...
export function SocialShareEditor({
  ...
  onChange,
  disabled,
}: BlockEditorProps<SocialShareAttrs>) {
  const toggleNetwork = (network: SocialShareAttrs["networks"][number], checked: boolean) => {
