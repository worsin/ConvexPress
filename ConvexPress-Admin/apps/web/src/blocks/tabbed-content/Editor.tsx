...
import type { TabbedContentAttrs } from "./schema";

const emptyTab: TabbedContentAttrs["tabs"][number] = {
  label: "New tab",
  title: "",
  body: "",
  mediaId: "",
...
export function TabbedContentEditor({
  attrs,
  onChange,
  disabled,
}: BlockEditorProps<TabbedContentAttrs>) {
  const updateTab = (index: number, patch: Partial<TabbedContentAttrs["tabs"][number]>) => {
    onChange({
      ...attrs,
