...
import type { AswStoryTimelineAttrs } from "./schema";

const emptyItem: AswStoryTimelineAttrs["items"][number] = {
  label: "",
  title: "",
  body: "",
  mediaId: "",
...
export function AswStoryTimelineEditor({
  attrs,
  onChange,
  disabled,
}: BlockEditorProps<AswStoryTimelineAttrs>) {
  const updateItem = (index: number, patch: Partial<AswStoryTimelineAttrs["items"][number]>) => {
    onChange({
      ...attrs,
