...
import type { CustomerShowcaseAttrs } from "./schema";

const emptyItem: CustomerShowcaseAttrs["items"][number] = {
  quote: "",
  name: "",
  role: "",
  company: "",
...
export function CustomerShowcaseEditor({
  attrs,
  onChange,
  disabled,
}: BlockEditorProps<CustomerShowcaseAttrs>) {
  const updateItem = (index: number, patch: Partial<CustomerShowcaseAttrs["items"][number]>) => {
    onChange({
      ...attrs,
