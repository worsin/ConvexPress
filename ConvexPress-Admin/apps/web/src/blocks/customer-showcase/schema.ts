...
export const customerShowcaseAttrsSchema = z.object({
  heading: z.string().max(140).default("Built with site product"),
...
export type CustomerShowcaseAttrs = z.infer<typeof customerShowcaseAttrsSchema>;
