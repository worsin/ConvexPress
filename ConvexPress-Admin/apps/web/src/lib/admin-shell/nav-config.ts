...
const PLATFORM_NAV_SECTIONS: AdminNavSection[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "commerce-shipping", label: "Shipping", to: "/commerce/settings/shipping" },
      { id: "commerce-tax", label: "Tax", to: "/commerce/settings/tax" },
    ],
  },
  {
    id: "products",
  ...
  },
  {
    ...
    children: [
      ...
      // ── Hidden — legacy Theme/Template Builder ────────────────────────────
      // The following routes still exist (with @deprecated headers + a
      // DeprecatedSystemBanner) but are intentionally not surfaced in the
      // sidebar. Templates are now generated by the design:* skill kit in
      // ConvexPress-Website/. The routes can still be reached by direct URL
      // for inspection, but the user-facing interface no longer advertises
      // them. Do NOT re-add to this list until/unless the legacy builder is
