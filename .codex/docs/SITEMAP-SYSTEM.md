...
- **Airtable Record:** `recqpdCaMCaXlZ4hi`
...
- **Airtable Record:** `reckkaTFfHI9Pllzo`
- **Type:** System
...
- **Payload:**
  ...
  ```
- **Subscribers:**
  - **Site Notification System** (`recXIzWad2B3bV54F`): Shows success toast to admin: "XML sitemap regenerated ({count} pages)"
  - **Email Notification System** (`recWWEEOmkPMK1NdT`): Sends batched daily digest email to admin
...
- **Airtable Record:** `recoCznr10Xs00Wku`
...
- **Airtable Record:** `rech8gvmEEjCcg6qM`
...
- **Airtable Record:** `recYIEvoAoTf2gzGe` (belongs to SEO System but served with sitemap directive)
...
|------|-----------------|-------|------------|----------|---------|
| Sitemap Generated | `recWWEEOmkPMK1NdT` | `seo.sitemap_generated` | Admin (site administrators) | Batched (daily digest) | "Sitemap updated successfully" |
...
|------|-----------------|-------|------|-----------|------------|
| Sitemap Regenerated | `recXIzWad2B3bV54F` | `seo.sitemap_generated` | Success (green) | No (toast, auto-dismiss 5s) | Admin who triggered or all admins if auto |
