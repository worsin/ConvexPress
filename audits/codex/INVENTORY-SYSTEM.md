...
Knowledge companion for the Inventory System in ConvexPress. Use this with `.codex/agents/experts/inventory-system.md` and `specs/ConvexPress/systems/inventory-system/PRD.md`.
