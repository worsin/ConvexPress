...
> = {
  google: { icon: GoogleIcon, label: "Google", strategy: "oauth_google" },
  github: { icon: GitHubIcon, label: "GitHub", strategy: "oauth_github" },
};
...
export function OAuthButtons({
  ...
  const handleOAuth = async (provider: OAuthProvider) => {
    ...
    try {
      ...
      // OAuth redirect errors are handled by Clerk
    }
  };
