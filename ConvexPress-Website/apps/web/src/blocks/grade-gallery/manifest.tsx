...
import { gradeGalleryAttrsSchema, type GradeGalleryAttrs } from "./schema";

function GradeGalleryRenderer({ attrs }: BlockRendererProps<GradeGalleryAttrs>) {
  return (
