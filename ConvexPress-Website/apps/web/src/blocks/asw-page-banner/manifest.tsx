...
import { aswPageBannerAttrsSchema, type AswPageBannerAttrs } from "./schema";

function AswPageBannerRenderer({ attrs }: BlockRendererProps<AswPageBannerAttrs>) {
  return (
...
export const definition = {
  ...
  title: "ASW Page Banner",
  version: 1,
  schema: aswPageBannerAttrsSchema,
  Renderer: AswPageBannerRenderer,
