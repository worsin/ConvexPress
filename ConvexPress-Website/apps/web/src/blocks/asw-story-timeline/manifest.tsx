...
import { aswStoryTimelineAttrsSchema, type AswStoryTimelineAttrs } from "./schema";

function AswStoryTimelineRenderer({ attrs }: BlockRendererProps<AswStoryTimelineAttrs>) {
  return (
...
export const definition = {
  ...
  title: "ASW Story Timeline",
  version: 1,
  schema: aswStoryTimelineAttrsSchema,
  Renderer: AswStoryTimelineRenderer,
