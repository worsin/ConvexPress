...
import { aswTabbedContentAttrsSchema, type AswTabbedContentAttrs } from "./schema";

function AswTabbedContentRenderer({ attrs }: BlockRendererProps<AswTabbedContentAttrs>) {
...
export const definition = {
  ...
  title: "ASW Tabbed Content",
  version: 1,
  schema: aswTabbedContentAttrsSchema,
  Renderer: AswTabbedContentRenderer,
