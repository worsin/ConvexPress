...
import { socialShareAttrsSchema, type SocialShareAttrs } from "./schema";

const labels: Record<SocialShareAttrs["networks"][number], string> = {
  facebook: "Facebook",
  x: "X",
  pinterest: "Pinterest",
  linkedin: "LinkedIn",
...
function shareHref(network: SocialShareAttrs["networks"][number], url: string) {
...
function SocialShareRenderer({ attrs }: BlockRendererProps<SocialShareAttrs>) {
