...
export const contactStackAttrsSchema = z.object({
  heading: z.string().max(140).default("Contact the site"),
...
export type ContactStackAttrs = z.infer<typeof contactStackAttrsSchema>;
