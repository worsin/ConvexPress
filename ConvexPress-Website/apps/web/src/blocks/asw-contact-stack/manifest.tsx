...
import { aswContactStackAttrsSchema, type AswContactStackAttrs } from "./schema";
...
function AswContactStackRenderer({ attrs }: BlockRendererProps<AswContactStackAttrs>) {
  return (
...
export const definition = {
  ...
  title: "ASW Contact Stack",
  version: 1,
  schema: aswContactStackAttrsSchema,
  Renderer: AswContactStackRenderer,
