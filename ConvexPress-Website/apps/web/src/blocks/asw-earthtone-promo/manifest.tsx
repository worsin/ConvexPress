...
import { aswEarthtonePromoAttrsSchema, type AswEarthtonePromoAttrs } from "./schema";

function AswEarthtonePromoRenderer({ attrs }: BlockRendererProps<AswEarthtonePromoAttrs>) {
  return (
...
export const definition = {
  ...
  title: "ASW EarthTone Promo",
  version: 1,
  schema: aswEarthtonePromoAttrsSchema,
  Renderer: AswEarthtonePromoRenderer,
