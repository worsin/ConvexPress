...
import { aswCustomerShowcaseAttrsSchema, type AswCustomerShowcaseAttrs } from "./schema";

function AswCustomerShowcaseRenderer({ attrs }: BlockRendererProps<AswCustomerShowcaseAttrs>) {
  return (
...
export const definition = {
  ...
  title: "ASW Customer Showcase",
  version: 1,
  schema: aswCustomerShowcaseAttrsSchema,
  Renderer: AswCustomerShowcaseRenderer,
