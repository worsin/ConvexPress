...
export const aswProductCollectionAttrsSchema = z.object({
  eyebrow: z.string().max(80).default(""),
  heading: z.string().max(140).default("Featured tonewoods"),
...
export type AswProductCollectionAttrs = z.infer<typeof aswProductCollectionAttrsSchema>;
export type AswProductCard = z.infer<typeof productCardSchema>;
