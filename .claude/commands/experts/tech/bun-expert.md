...
> **Note:** No Bun-specific debug playbook entries exist in the Airtable database yet. The following are derived from the Known Issues database above. Add entries to `tblfvvhaM8MiFHI64` with Technology = Bun as issues are encountered.
