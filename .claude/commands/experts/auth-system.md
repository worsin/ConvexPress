...
| Failed login detection | DONE | `failedLoginAttempts` table, `recordFailedLogin` mutation, `getUnreviewedFailedLoginCount` badge query, `getSecurityOverview` user query |
