...
- **Impact:** The Audit Log System cannot record notification deliveries because no event is emitted when a notification is created. The knowledge doc explicitly specifies this event with Airtable record `reczTii8GoZ8U5WDD`.
