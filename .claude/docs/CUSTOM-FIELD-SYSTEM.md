...
- **Airtable Record:** `recRQ7muiuk2iKP0s`
- **Type:** Mutation
- **Auth:** Required
...
- **Airtable Record:** `recE2VAhTp9rj6y0F`
- **Type:** Mutation
- **Auth:** Required
- **Capabilities:** `manage_custom_fields` (Administrator only)
- **Args:**
...
- **Airtable Record:** `recF9vhJuNjtjtaOM`
- **Type:** Mutation
- **Auth:** Required
- **Capabilities:** `manage_custom_fields` (Administrator only)
- **Args:**
...
- **Airtable Record:** `recNIPdVgvP6ZrV3g`
- **Type:** Mutation
- **Auth:** Required
...
- **Airtable Record:** `recl1t7iswmFVRRSO`
- **Args:**
  ```typescript
  {
    entityType: v.string(),
...
- **Airtable Route Record:** `recCxjyYha0D2DNtR`
...
- **Airtable Route Record:** `recCwypDVPrCmrfpA`
