...
- **Airtable Record:** `recgB64eUQaxwIXPB`
...
- **Airtable Record:** `recX4K0FLHpEC5htk`
...
- **Airtable Record:** `recMsYAfsIJuYRHd6`
...
- **Airtable Record:** `recJiE8FI5TLvnxvK`
- **Type:** Content
...
- **Airtable Record:** `recEzGWOlQ09TgRcn`
...
- **Airtable Record:** `recc1A0RhONsz4NaV`
...
- **Airtable Record:** `recYIEvoAoTf2gzGe`
...
- **Airtable Record:** `rec0rp35wJr6MkpIw`
...
|------|-------|------------|----------|---------|
| Sitemap Generated (`recWWEEOmkPMK1NdT`) | `seo.sitemap_generated` | All Administrators | Batched | "Sitemap updated successfully" |
...
|------|-------|------|-----------|------------|
| SEO Updated (`recJ5OCQrF9XRjN5q`) | `seo.updated` | Info (blue) | No (toast, 5s auto-dismiss) | The user who updated SEO |
| Sitemap Regenerated (`recXIzWad2B3bV54F`) | `seo.sitemap_generated` | Success (green) | No (toast) | All Administrators |
