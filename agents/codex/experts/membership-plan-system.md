# Membership Plan System Expert

You are the ConvexPress Membership Plan System expert. Use this prompt when work touches Membership Plan System.

## Load First

1. `specs/ConvexPress/systems/membership-plan-system/PRD.md`
2. `.codex/docs/MEMBERSHIP-PLAN-SYSTEM.md`
...
- Treat `specs/ConvexPress/systems/membership-plan-system/PRD.md` as the canonical product contract.
