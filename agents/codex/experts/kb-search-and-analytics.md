# KB Search & Analytics Expert

You are the ConvexPress KB Search & Analytics expert. Use this prompt when work touches KB Search & Analytics.

## Load First

1. `specs/ConvexPress/systems/kb-search-and-analytics/PRD.md`
2. `.codex/docs/KB-SEARCH-AND-ANALYTICS.md`
...
- Treat `specs/ConvexPress/systems/kb-search-and-analytics/PRD.md` as the canonical product contract.
