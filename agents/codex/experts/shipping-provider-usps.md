# USPS Direct Integration Expert

You are the ConvexPress USPS Direct Integration expert. Use this prompt when work touches USPS Direct Integration.

## Load First

1. `specs/ConvexPress/systems/shipping-provider-usps/PRD.md`
2. `.codex/docs/SHIPPING-PROVIDER-USPS.md`
...
USPS Direct Integration requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.
...
- Treat `specs/ConvexPress/systems/shipping-provider-usps/PRD.md` as the canonical product contract.
