# Support Analytics System Expert

You are the ConvexPress Support Analytics System expert. Use this prompt when work touches Support Analytics System.

## Load First

1. `specs/ConvexPress/systems/support-analytics-system/PRD.md`
2. `.codex/docs/SUPPORT-ANALYTICS-SYSTEM.md`
...
- Treat `specs/ConvexPress/systems/support-analytics-system/PRD.md` as the canonical product contract.
