# Gallery System Expert

You are the ConvexPress Gallery System expert. Use this prompt when work touches Gallery System.

## Load First

1. `specs/ConvexPress/systems/gallery-system/PRD.md`
2. `.codex/docs/GALLERY-SYSTEM.md`
...
Gallery albums, media groupings, album rendering, and gallery management.
...
- Treat `specs/ConvexPress/systems/gallery-system/PRD.md` as the canonical product contract.
