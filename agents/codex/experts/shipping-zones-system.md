# Shipping Zone System Expert

You are the ConvexPress Shipping Zone System expert. Use this prompt when work touches Shipping Zone System.

## Load First

1. `specs/ConvexPress/systems/shipping-zones-system/PRD.md`
2. `.codex/docs/SHIPPING-ZONES-SYSTEM.md`
...
Shipping Zone System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.
...
- Treat `specs/ConvexPress/systems/shipping-zones-system/PRD.md` as the canonical product contract.
