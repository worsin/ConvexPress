# KB Category System Expert

You are the ConvexPress KB Category System expert. Use this prompt when work touches KB Category System.

## Load First

1. `specs/ConvexPress/systems/kb-category-system/PRD.md`
2. `.codex/docs/KB-CATEGORY-SYSTEM.md`
...
- Treat `specs/ConvexPress/systems/kb-category-system/PRD.md` as the canonical product contract.
