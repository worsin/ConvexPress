# Subscription Billing System Expert

You are the ConvexPress Subscription Billing System expert. Use this prompt when work touches Subscription Billing System.

## Load First

1. `specs/ConvexPress/systems/subscription-billing-system/PRD.md`
2. `.codex/docs/SUBSCRIPTION-BILLING-SYSTEM.md`
...
Recurring invoices, renewal charging, proration, failed payment recovery, and billing history.
...
- Treat `specs/ConvexPress/systems/subscription-billing-system/PRD.md` as the canonical product contract.
