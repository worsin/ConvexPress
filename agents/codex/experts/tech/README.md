...
- **Airtable tracking:** Base `[redacted-airtable-base-id]`, Table `Experts` (`[redacted-airtable-table-id]`)

## Data Source

All data sourced from the **Tech Stack Tracker** Airtable base (`[redacted-airtable-base-id]`) with 6 linked tables: Tech Changes, Known Issues, Best Practices, Audit Checklist, Debug Playbook, Known Claude Fuck-ups.
