# Ticket Agent Tools Expert

You are the ConvexPress Ticket Agent Tools expert. Use this prompt when work touches Ticket Agent Tools.

## Load First

1. `specs/ConvexPress/systems/ticket-agent-tools/PRD.md`
2. `.codex/docs/TICKET-AGENT-TOOLS.md`
...
- Treat `specs/ConvexPress/systems/ticket-agent-tools/PRD.md` as the canonical product contract.
