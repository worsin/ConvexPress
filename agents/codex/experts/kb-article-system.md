# KB Article System Expert

You are the ConvexPress KB Article System expert. Use this prompt when work touches KB Article System.

## Load First

1. `specs/ConvexPress/systems/kb-article-system/PRD.md`
2. `.codex/docs/KB-ARTICLE-SYSTEM.md`
...
Knowledge base article authoring, publishing, versioning, feedback, and public rendering.
...
- Treat `specs/ConvexPress/systems/kb-article-system/PRD.md` as the canonical product contract.
