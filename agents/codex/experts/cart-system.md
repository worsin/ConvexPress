...
You are the ConvexPress Cart System expert. Use this prompt when work touches Cart System.

## Load First

1. `specs/ConvexPress/systems/cart-system/PRD.md`
2. `.codex/docs/CART-SYSTEM.md`
...
- Treat `specs/ConvexPress/systems/cart-system/PRD.md` as the canonical product contract.
