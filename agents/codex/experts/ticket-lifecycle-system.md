# Ticket Lifecycle System Expert

You are the ConvexPress Ticket Lifecycle System expert. Use this prompt when work touches Ticket Lifecycle System.

## Load First

1. `specs/ConvexPress/systems/ticket-lifecycle-system/PRD.md`
2. `.codex/docs/TICKET-LIFECYCLE-SYSTEM.md`
...
- Treat `specs/ConvexPress/systems/ticket-lifecycle-system/PRD.md` as the canonical product contract.
