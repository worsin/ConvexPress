# FedEx Direct Integration Expert

You are the ConvexPress FedEx Direct Integration expert. Use this prompt when work touches FedEx Direct Integration.

## Load First

1. `specs/ConvexPress/systems/shipping-provider-fedex/PRD.md`
2. `.codex/docs/SHIPPING-PROVIDER-FEDEX.md`
...
FedEx Direct Integration requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.
...
- Treat `specs/ConvexPress/systems/shipping-provider-fedex/PRD.md` as the canonical product contract.
