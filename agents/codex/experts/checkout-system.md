# Checkout System Expert

You are the ConvexPress Checkout System expert. Use this prompt when work touches Checkout System.

## Load First

1. `specs/ConvexPress/systems/checkout-system/PRD.md`
2. `.codex/docs/CHECKOUT-SYSTEM.md`
...
- Treat `specs/ConvexPress/systems/checkout-system/PRD.md` as the canonical product contract.
