# Support Deflection System Expert

You are the ConvexPress Support Deflection System expert. Use this prompt when work touches Support Deflection System.

## Load First

1. `specs/ConvexPress/systems/support-deflection-system/PRD.md`
2. `.codex/docs/SUPPORT-DEFLECTION-SYSTEM.md`
...
AI and KB-driven support deflection before ticket creation.
...
- Treat `specs/ConvexPress/systems/support-deflection-system/PRD.md` as the canonical product contract.
