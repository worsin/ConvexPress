...
Knowledge companion for the Subscription System in ConvexPress. Use this with `.codex/agents/experts/subscription-system.md` and `specs/ConvexPress/systems/subscription-system/PRD.md`.
