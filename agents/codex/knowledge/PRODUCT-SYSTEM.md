...
Knowledge companion for the Product System in ConvexPress. Use this with `.codex/agents/experts/product-system.md` and `specs/ConvexPress/systems/product-system/PRD.md`.
