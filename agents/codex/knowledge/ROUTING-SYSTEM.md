...
#### `routing.[redacted-airtable-record-id]`
- **Type:** internalMutation
...
|------|-------|------|-----------|------------|-----------|
| Permalink Changed | `settings.permalinks_changed` | Warning | Yes | Administrator | `[redacted-airtable-record-id]` |
...
- [ ] `convex/routing/internal.ts` - 6 internal functions: resolveRedirect, generateSlugRedirect, generatePermalinkRedirects, batchCreateRedirects, [redacted-airtable-record-id], log404, regeneratePatterns
