...
Knowledge companion for the WordPress Sync System in ConvexPress. Use this with `.codex/agents/experts/wordpress-sync-system.md` and `specs/ConvexPress/systems/wordpress-sync-system/PRD.md`.

## Boundary

WordPress and WooCommerce import/sync workflows, mapping, reconciliation, and migration tooling.
