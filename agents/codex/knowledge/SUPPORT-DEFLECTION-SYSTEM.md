...
Knowledge companion for the Support Deflection System in ConvexPress. Use this with `.codex/agents/experts/support-deflection-system.md` and `specs/ConvexPress/systems/support-deflection-system/PRD.md`.
