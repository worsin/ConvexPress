...
Knowledge companion for the Customer System in ConvexPress. Use this with `.codex/agents/experts/customer-system.md` and `specs/ConvexPress/systems/customer-system/PRD.md`.
