...
Knowledge companion for the Product Bundles System in ConvexPress. Use this with `.codex/agents/experts/product-bundles-system.md` and `specs/ConvexPress/systems/product-bundles-system/PRD.md`.
