...
- Agent: $(@{Name=Media System Expert; Path=.codex/docs/MEDIA-SYSTEM.md}.Name)
- Source file: $(@{Name=Media System Expert; Path=.codex/docs/MEDIA-SYSTEM.md}.Path)
...
|------|----------|-------|------------|----------|---------|
| Media Storage Warning | `[redacted-airtable-record-id]` | `media.uploaded` | Admin (Administrators only) | Batched | "Storage usage approaching limit" |
...
|------|----------|-------|------|-----------|------------|
| Media Uploaded | `[redacted-airtable-record-id]` | `media.uploaded` | Success (green) | No (5s auto-dismiss) | Employee (uploader) |
| Media Deleted | `[redacted-airtable-record-id]` | `media.deleted` | Info (blue) | No (5s auto-dismiss) | Employee (deleter) |
