...
Knowledge companion for the Product Category System in ConvexPress. Use this with `.codex/agents/experts/product-category-system.md` and `specs/ConvexPress/systems/product-category-system/PRD.md`.
