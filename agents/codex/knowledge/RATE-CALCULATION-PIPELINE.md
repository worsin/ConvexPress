...
Knowledge companion for the Shipping Rate Engine in ConvexPress. Use this with `.codex/agents/experts/rate-calculation-pipeline.md` and `specs/ConvexPress/systems/rate-calculation-pipeline/PRD.md`.
