...
**System Record:** `[redacted-airtable-record-id]`
**Expert Record:** `[redacted-airtable-record-id]`
...
- **Airtable Action Record:** `[redacted-airtable-record-id]`
- **Args:**
  ```typescript
  {
    section: "general",
...
|------|-------|------------|----------|---------|-----------|
| Settings Changed Alert | `settings.updated`, `settings.permalinks_changed` | All Administrators | Batched (5-min window) | "Site settings were updated" | `[redacted-airtable-record-id]` |
...
|------|-------|------|-----------|------------|-----------|
| Settings Updated | `settings.updated` | Info | No (auto-dismiss) | All Administrators | `[redacted-airtable-record-id]` |
| Permalink Changed | `settings.permalinks_changed` | Warning | Yes (stays until dismissed) | All Administrators | `[redacted-airtable-record-id]` |
...
|--------|------|----------------|
| **Role & Capability System** (`[redacted-airtable-record-id]`) | **Hard** | `manage_options` capability check on every settings route and mutation. Cannot function without role checks. |
...
|--------|------|----------------|
| **Routing System** (`[redacted-airtable-record-id]`) | **Hard** | Permalink structure, categoryBase, tagBase for URL generation and resolution. Listens for `settings.permalinks_changed` event. |
