...
Knowledge companion for the Ticket Widget System in ConvexPress. Use this with `.codex/agents/experts/ticket-widget-system.md` and `specs/ConvexPress/systems/ticket-widget-system/PRD.md`.
