# USPS Direct Integration

## Role

Knowledge companion for the USPS Direct Integration in ConvexPress. Use this with `.codex/agents/experts/shipping-provider-usps.md` and `specs/ConvexPress/systems/shipping-provider-usps/PRD.md`.
