...
|--------|------|-------|----------|----------------|-------------|
| Create Menu | `menu.create` | Administrator | Create | `menu.created` | `[redacted-airtable-record-id]` |
| Update Menu | `menu.update` | Administrator | Update | `menu.updated` | `[redacted-airtable-record-id]` |
| Delete Menu | `menu.delete` | Administrator | Delete | `menu.deleted` | `[redacted-airtable-record-id]` |
| Add Menu Item | `menu.add_item` | Administrator | Create | - | `[redacted-airtable-record-id]` |
| Update Menu Item | `menu.update_item` | Administrator | Update | - | `[redacted-airtable-record-id]` |
| Delete Menu Item | `menu.delete_item` | Administrator | Delete | - | `[redacted-airtable-record-id]` |
| Reorder Menu Items | `menu.reorder` | Administrator | Bulk | - | `[redacted-airtable-record-id]` |
| Assign Menu to Location | `menu.assign_location` | Administrator | Config | `menu.location_assigned` | `[redacted-airtable-record-id]` |
...
|------|-------|------|-----------|-----------------|-------------|
| Menu Updated | `menu.updated` | Success | Admin (actor) | `Menu "{name}" updated` | `[redacted-airtable-record-id]` |
| Menu Location Assigned | `menu.location_assigned` | Info | Admin (actor) | `Menu assigned to {location}` | `[redacted-airtable-record-id]` |
