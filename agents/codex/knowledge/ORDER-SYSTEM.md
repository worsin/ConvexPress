...
Knowledge companion for the Order System in ConvexPress. Use this with `.codex/agents/experts/order-system.md` and `specs/ConvexPress/systems/order-system/PRD.md`.
