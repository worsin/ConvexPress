...
Knowledge companion for the Recipe System in ConvexPress. Use this with `.codex/agents/experts/recipe-system.md` and `specs/ConvexPress/systems/recipe-system/PRD.md`.
