...
|------|-----------------|-------|------------|----------|---------|
| New Comment on Your Post | `[redacted-airtable-record-id]` | `comment.created` | Post Author | Immediate | `New comment on "{post_title}"` |
| Comment Pending Moderation | `[redacted-airtable-record-id]` | `comment.created` | Admins | Batched | `New comment awaiting moderation` |
| Comment Reply Notification | `[redacted-airtable-record-id]` | `comment.replied` | Parent Comment Author | Immediate | `Someone replied to your comment` |
| Comment Approved | `[redacted-airtable-record-id]` | `comment.approved` | Comment Author | Batched | `Your comment was approved` |
| Comment Digest | `[redacted-airtable-record-id]` | Scheduled (weekly) | Post Authors | Digest | `Comments this week on your posts` |
...
|------|-----------------|-------|------|-----------|------------|
| New Comment | `[redacted-airtable-record-id]` | `comment.created` | Info | Yes | Post Author |
| Pending Comments | `[redacted-airtable-record-id]` | `comment.created` | Info | Yes | Admins |
| Comment Reply | `[redacted-airtable-record-id]` | `comment.replied` | Info | Yes | Parent Comment Author |
| Comment Approved | `[redacted-airtable-record-id]` | `comment.approved` | Success | No (toast) | Comment Author |
| Comment Rejected | `[redacted-airtable-record-id]` | `comment.rejected` | Warning | No (toast) | Comment Author |
| Comment Flagged | `[redacted-airtable-record-id]` | `comment.flagged` | Warning | Yes | Admins |
