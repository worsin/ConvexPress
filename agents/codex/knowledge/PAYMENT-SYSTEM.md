...
Knowledge companion for the Payment System in ConvexPress. Use this with `.codex/agents/experts/payment-system.md` and `specs/ConvexPress/systems/payment-system/PRD.md`.
