...
- Create: `docs/stripe-integration.md` — documents the divergence from Stripe Billing (we manage invoices; Stripe handles charges only)
...
**Files:**
- Create: `docs/stripe-integration.md`
...
```bash
git add docs/stripe-integration.md
...
- Stripe Billing webhook surface (intentionally diverges — see `docs/stripe-integration.md`)
See `docs/superpowers/reports/2026-04-21-membership-subscriptions-acceptance.md` (Wave 9 addendum + Wave 10 completion) for evidence.
```
...
Run from repo root:
```bash
airtable records update --base appqpJ8QQkoKsH02O --table Systems --id recCpq6vU6f9gqPZL --fields '{"Completion": 1}'
airtable records update --base appqpJ8QQkoKsH02O --table Systems --id recidrtZmxHrh0rON --fields '{"Completion": 1}'
airtable records update --base appqpJ8QQkoKsH02O --table Systems --id rec7Eayn6V8Vft1Vl --fields '{"Completion": 1}'
airtable records update --base appqpJ8QQkoKsH02O --table Systems --id recgbNuzg3lSyN3Br --fields '{"Completion": 0.95}'
airtable records update --base appqpJ8QQkoKsH02O --table Systems --id rectnFOFoGysK3DQC --fields '{"Completion": 0.95}'
```
...
**Files:**
- Modify: `docs/superpowers/reports/2026-04-21-membership-subscriptions-acceptance.md`
...
- **Docs**: `docs/stripe-integration.md` documents our divergence from Stripe Billing; audit backlog and Airtable Systems records reflect the new completion state.
...
```bash
git add docs/superpowers/reports/2026-04-21-membership-subscriptions-acceptance.md
