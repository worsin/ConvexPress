...
- **`.claude/KITS-ROADMAP.md`** — Skill-kit standard, existing kits, and agreed-on future kits
- **`.claude/docs/`** — Per-system expert knowledge docs (38 systems)
- **`ConvexPress-Website/design-kit/`** — AI template-generation kit (docs + reference code)
- **`ConvexPress-Admin/extension-kit/`** — AI extension-building kit (docs + reference code)
