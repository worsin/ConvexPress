...
> **Canonical path:** `specs/ConvexPress/systems/revision-system/PRD.md`
> **Project:** ConvexPress
...
Revision System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Revision System.
...
- Codex expert: `.codex/agents/experts/revision-system.md`
- Knowledge doc: `.codex/docs/REVISION-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Revision System
