# PRD: Role & Capability System

> **Canonical path:** `specs/ConvexPress/systems/role-capability-system/PRD.md`
> **Project:** ConvexPress
...
Role & Capability System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Role & Capability System.
...
- Codex expert: `.codex/agents/experts/role-capability-system.md`
- Knowledge doc: `.codex/docs/ROLE-CAPABILITY-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Role & Capability System
