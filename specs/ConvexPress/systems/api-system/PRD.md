...
> **Canonical path:** `specs/ConvexPress/systems/api-system/PRD.md`
> **Project:** ConvexPress
...
API System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for API System.
...
- Codex expert: `.codex/agents/experts/api-system.md`
- Knowledge doc: `.codex/docs/API-SYSTEM.md`
- Airtable table: ConvexPress / Systems / API System
