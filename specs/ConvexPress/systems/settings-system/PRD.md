...
> **Canonical path:** `specs/ConvexPress/systems/settings-system/PRD.md`
> **Project:** ConvexPress
...
Settings System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Settings System.
...
- Codex expert: `.codex/agents/experts/settings-system.md`
- Knowledge doc: `.codex/docs/SETTINGS-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Settings System
