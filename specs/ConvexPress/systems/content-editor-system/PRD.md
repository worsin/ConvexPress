# PRD: Content Editor System

> **Canonical path:** `specs/ConvexPress/systems/content-editor-system/PRD.md`
> **Project:** ConvexPress
...
Content Editor System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Content Editor System.
...
- Codex expert: `.codex/agents/experts/content-editor-system.md`
- Knowledge doc: `.codex/docs/CONTENT-EDITOR-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Content Editor System
