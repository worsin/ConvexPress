...
> **Canonical path:** `specs/ConvexPress/systems/post-system/PRD.md`
> **Project:** ConvexPress
...
Post System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Post System.
...
- Codex expert: `.codex/agents/experts/post-system.md`
- Knowledge doc: `.codex/docs/POST-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Post System
