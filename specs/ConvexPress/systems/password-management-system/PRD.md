# PRD: Password Management System

> **Canonical path:** `specs/ConvexPress/systems/password-management-system/PRD.md`
> **Project:** ConvexPress
...
Password Management System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Password Management System.
...
- Codex expert: `.codex/agents/experts/password-management-system.md`
- Knowledge doc: `.codex/docs/PASSWORD-MANAGEMENT-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Password Management System
