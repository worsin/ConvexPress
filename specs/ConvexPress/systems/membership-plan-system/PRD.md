# PRD: Membership Plan System

> **Canonical path:** `specs/ConvexPress/systems/membership-plan-system/PRD.md`
> **Project:** ConvexPress
...
Membership plans, grants, benefits, restriction rules, and subscription-to-membership bridges.

## Scope

- Define the product and operational contract for Membership Plan System.
...
- Codex expert: `.codex/agents/experts/membership-plan-system.md`
- Knowledge doc: `.codex/docs/MEMBERSHIP-PLAN-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Membership Plan System
