...
> **Canonical path:** `specs/ConvexPress/systems/menu-system/PRD.md`
> **Project:** ConvexPress
...
Menu System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Menu System.
...
- Codex expert: `.codex/agents/experts/menu-system.md`
- Knowledge doc: `.codex/docs/MENU-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Menu System
