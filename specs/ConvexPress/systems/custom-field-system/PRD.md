# PRD: Custom Field System

> **Canonical path:** `specs/ConvexPress/systems/custom-field-system/PRD.md`
> **Project:** ConvexPress
...
Custom Field System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Custom Field System.
...
- Codex expert: `.codex/agents/experts/custom-field-system.md`
- Knowledge doc: `.codex/docs/CUSTOM-FIELD-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Custom Field System
