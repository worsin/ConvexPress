# PRD: Dashboard System

> **Canonical path:** `specs/ConvexPress/systems/dashboard-system/PRD.md`
> **Project:** ConvexPress
...
Dashboard System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Dashboard System.
...
- Codex expert: `.codex/agents/experts/dashboard-system.md`
- Knowledge doc: `.codex/docs/DASHBOARD-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Dashboard System
