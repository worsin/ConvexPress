...
> **Canonical path:** `specs/ConvexPress/systems/taxonomy-system/PRD.md`
> **Project:** ConvexPress
...
Taxonomy System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Taxonomy System.
...
- Codex expert: `.codex/agents/experts/taxonomy-system.md`
- Knowledge doc: `.codex/docs/TAXONOMY-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Taxonomy System
