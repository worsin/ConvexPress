...
> **Canonical path:** `specs/ConvexPress/systems/rss-feed-system/PRD.md`
> **Project:** ConvexPress
...
RSS/Feed System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for RSS/Feed System.
...
- Codex expert: `.codex/agents/experts/rss-feed-system.md`
- Knowledge doc: `.codex/docs/RSS-FEED-SYSTEM.md`
- Airtable table: ConvexPress / Systems / RSS/Feed System
