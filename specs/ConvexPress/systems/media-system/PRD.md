...
> **Canonical path:** `specs/ConvexPress/systems/media-system/PRD.md`
> **Project:** ConvexPress
...
Media System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Media System.
...
- Codex expert: `.codex/agents/experts/media-system.md`
- Knowledge doc: `.codex/docs/MEDIA-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Media System
