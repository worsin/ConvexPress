...
> **Canonical path:** `specs/ConvexPress/systems/comment-system/PRD.md`
> **Project:** ConvexPress
...
Comment System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Comment System.
...
- Codex expert: `.codex/agents/experts/comment-system.md`
- Knowledge doc: `.codex/docs/COMMENT-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Comment System
