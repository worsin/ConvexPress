...
> **Canonical path:** `specs/ConvexPress/systems/search-system/PRD.md`
> **Project:** ConvexPress
...
Search System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Search System.
...
- Codex expert: `.codex/agents/experts/search-system.md`
- Knowledge doc: `.codex/docs/SEARCH-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Search System
