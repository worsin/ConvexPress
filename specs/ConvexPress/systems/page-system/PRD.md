...
> **Canonical path:** `specs/ConvexPress/systems/page-system/PRD.md`
> **Project:** ConvexPress
...
Page System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Page System.
...
- Codex expert: `.codex/agents/experts/page-system.md`
- Knowledge doc: `.codex/docs/PAGE-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Page System
