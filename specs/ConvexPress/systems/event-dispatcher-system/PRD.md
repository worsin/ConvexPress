# PRD: Event Dispatcher System

> **Canonical path:** `specs/ConvexPress/systems/event-dispatcher-system/PRD.md`
> **Project:** ConvexPress
...
Event Dispatcher System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Event Dispatcher System.
...
- Codex expert: `.codex/agents/experts/event-dispatcher-system.md`
- Knowledge doc: `.codex/docs/EVENT-DISPATCHER-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Event Dispatcher System
