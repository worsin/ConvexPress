...
> **Canonical path:** `specs/ConvexPress/systems/sitemap-system/PRD.md`
> **Project:** ConvexPress
...
Sitemap System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Sitemap System.
...
- Codex expert: `.codex/agents/experts/sitemap-system.md`
- Knowledge doc: `.codex/docs/SITEMAP-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Sitemap System
