...
> **Canonical path:** `specs/ConvexPress/systems/email-notification-system/PRD.md`
> **Project:** ConvexPress
...
Email Notification System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Email Notification System.
...
- Codex expert: `.codex/agents/experts/email-notification-system.md`
- Knowledge doc: `.codex/docs/EMAIL-NOTIFICATION-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Email Notification System
