...
**Positioning:** internal extension (`commerceSubscriptions`).
**Extension gate:** ``commerce.subscriptions.commerceSubscriptionsEnabled`` in the Settings system; `requireX(ctx)` helper on every mutation/query. Admin UI hides the nav item when disabled.
**Code lives at:** `ConvexPress-Admin/packages/backend/convex/commerceSubscriptions/`
...
- **Event Dispatcher** — emits `commerce.subscription_*` events.

**WooCommerce analog:** WooCommerce Subscriptions (Automattic) — recurring billing with trials, proration, and dunning.
...
- [Payment System PRD](./the Payment System PRD (`specs/ConvexPress/systems/payment-system/PRD.md`).md)
- [Checkout System PRD](./the Checkout System PRD (`specs/ConvexPress/systems/checkout-system/PRD.md`).md)
- [Product Bundles PRD](./the Product Bundles System PRD (`specs/ConvexPress/systems/product-bundles-system/PRD.md`).md)
