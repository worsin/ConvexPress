...
> **Canonical path:** `specs/ConvexPress/systems/gallery-system/PRD.md`
> **Project:** ConvexPress
...
- Define the product and operational contract for Gallery System.
...
- Codex expert: `.codex/agents/experts/gallery-system.md`
- Knowledge doc: `.codex/docs/GALLERY-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Gallery System
