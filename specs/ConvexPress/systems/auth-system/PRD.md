...
> **Canonical path:** `specs/ConvexPress/systems/auth-system/PRD.md`
> **Project:** ConvexPress
...
Auth System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Auth System.
...
- Codex expert: `.codex/agents/experts/auth-system.md`
- Knowledge doc: `.codex/docs/AUTH-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Auth System
