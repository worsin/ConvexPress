...
> **Canonical path:** `specs/ConvexPress/systems/site-notification-system/PRD.md`
> **Project:** ConvexPress
...
Site Notification System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Site Notification System.
...
- Codex expert: `.codex/agents/experts/site-notification-system.md`
- Knowledge doc: `.codex/docs/SITE-NOTIFICATION-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Site Notification System
