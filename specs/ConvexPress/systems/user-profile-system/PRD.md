...
> **Canonical path:** `specs/ConvexPress/systems/user-profile-system/PRD.md`
> **Project:** ConvexPress
...
User Profile System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for User Profile System.
...
- Codex expert: `.codex/agents/experts/user-profile-system.md`
- Knowledge doc: `.codex/docs/USER-PROFILE-SYSTEM.md`
- Airtable table: ConvexPress / Systems / User Profile System
