...
> **Canonical path:** `specs/ConvexPress/systems/audit-log-system/PRD.md`
> **Project:** ConvexPress
...
Audit Log System requirements, implementation boundaries, integrations, and operational behavior in ConvexPress.

## Scope

- Define the product and operational contract for Audit Log System.
...
- Codex expert: `.codex/agents/experts/audit-log-system.md`
- Knowledge doc: `.codex/docs/AUDIT-LOG-SYSTEM.md`
- Airtable table: ConvexPress / Systems / Audit Log System
