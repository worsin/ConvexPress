...
| Events | [redacted-airtable-record-id] |
| Email Notifications | [redacted-airtable-record-id] |

### B. Role Record IDs

| Role | Record ID |
|------|-----------|
| Guest | [redacted-airtable-record-id] |
| Customer | [redacted-airtable-record-id] |
| Staff | [redacted-airtable-record-id] |
| Manager | [redacted-airtable-record-id] |
| Admin | [redacted-airtable-record-id] |
| System | [redacted-airtable-record-id] |
